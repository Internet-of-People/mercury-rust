...
pub fn cli<'a, 'b>() -> App<'a, 'b> {
    App::new("TheButton")
        ...
        .arg(
            Arg::with_name(CLI_VERBOSE)
                .short("v")
                .long(CLI_VERBOSE)
                .multiple(true)
                .help("Sets the level of verbosity"),
        )
        .arg(Arg::with_name(CLI_VERSION).short("V").long(CLI_VERSION).help("software version"))
        .arg(
            Arg::with_name(CLI_PRIVATE_KEY_FILE)
        ...
        .arg(
            Arg::with_name(CLI_SERVER_ADDRESS)
        ...
        .subcommand(
            SubCommand::with_name(CLI_SERVER)
                ...
                //            )
                .arg(
                    Arg::with_name(CLI_EVENT_TIMER)
                        .long(CLI_EVENT_TIMER)
                        .takes_value(true)
                        .value_name("SECS")
                        .help("Generate a button press event every n seconds"),
        ...
        .subcommand(
            SubCommand::with_name(CLI_CLIENT)
                .about("Sets running mode to client")
                .arg(
                    Arg::with_name("on-fail")
                        .long("on-fail")
                        .takes_value(true)
                        .value_name("FAIL")
                        .help(
                ...
                .arg(
                    Arg::with_name(CLI_SERVER_PROFILE)
